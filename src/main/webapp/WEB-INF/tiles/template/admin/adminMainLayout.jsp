...
<html lang="en">
	<head>
	    ...
	    <!-- iCheck -->
	    <link rel="stylesheet" href="<c:url value = "/resources/admin/plugins/iCheck/flat/blue.css" />" >
	    
	    <!-- Morris chart -->
	    <link rel="stylesheet" href="<c:url value = "/resources/admin/plugins/morris/morris.css" />" >
	    ...
	    <!-- Daterange picker -->
	    <link rel="stylesheet" href="<c:url value = "/resources/admin/plugins/daterangepicker/daterangepicker-bs3.css"/>" >
	    
	    <!-- bootstrap wysihtml5 - text editor -->
	    <link rel="stylesheet" href="<c:url value = "/resources/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css"/>" >
	
		<!-- DataTables -->
		<link rel="stylesheet" href="<c:url value = "/resources/admin/plugins/datatables/dataTables.bootstrap.css" />">
	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
		    ...
		    <script src="<c:url value = "/resources/admin/plugins/morris/morris.min.js" />"></script>
		    <!-- Sparkline -->
		    <script src="<c:url value = "/resources/admin/plugins/sparkline/jquery.sparkline.min.js" />"></script>
		    <!-- jvectormap -->
		    ...
		    <!-- jQuery Knob Chart -->
		    <script src="<c:url value = "/resources/admin/plugins/knob/jquery.knob.js" />"></script>
		    <!-- daterangepicker -->
		    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
		    <script src="<c:url value = "/resources/admin/plugins/daterangepicker/daterangepicker.js" />"></script>
		    <!-- datepicker -->
		    <script src="<c:url value = "/resources/admin/plugins/datepicker/bootstrap-datepicker.js" />"></script>
		    <!-- Bootstrap WYSIHTML5 -->
		    <script src="<c:url value = "/resources/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" />"></script>
		    <!-- Slimscroll -->
